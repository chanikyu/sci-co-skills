...
| Skill | 기능 |
|---|---|
| 🧬 [amplicon-analysis](https://github.com/chanikyu/SciCo-Skills/wiki/amplicon-analysis) | 16S/ITS 마이크로바이옴 파이프라인 — 전처리 → **알파** & **베타** 다양성(거리, PCoA, PERMANOVA) → **차등 존재비** — 저널 그림까지. scikit-bio 기반이며, 그림은 `scientific-data-viz`를 재사용합니다. |
