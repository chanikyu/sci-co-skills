...
| Skill | Qué hace |
|---|---|
| 🧬 [amplicon-analysis](https://github.com/chanikyu/SciCo-Skills/wiki/amplicon-analysis) | Pipeline de microbioma 16S/ITS — preprocesamiento → diversidad **alfa** y **beta** (distancia, PCoA, PERMANOVA) → **abundancia diferencial** — con figuras de revista. Impulsada por scikit-bio; reutiliza `scientific-data-viz` para las figuras. |
